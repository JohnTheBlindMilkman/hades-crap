...
void femtoMerge(TString fileName = "/home/jedkol/Downloads/HADES/HADES-CrAP/slurmOutput/apr12ana_all_24_02_19.root", TString signName = "hQinvSign_", TString bckgName = "hQinvBckg_", int ktMax = 5, int yMax = 3, int psiMax = 8)
{ 
