...
void femtoMerge(TString fileName = "/u/kjedrzej/hades-crap/slurmOutput/apr12sim_all_24_02_23.root", TString signName = "hQoslSign_", TString bckgName = "hQoslBckg_", int ktMax = 5, int yMax = 3, int psiMax = 8)
{ 
